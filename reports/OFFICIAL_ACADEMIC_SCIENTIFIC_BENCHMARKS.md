...
**Дата проведения:** `2026-08-23T18:11:49`
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **OpenAI HumanEval** | `pass@1 (%)` | **12.5%** | **12.5%** | **12.5%** | **12.5%** |
...
2. **OpenAI HumanEval (pass@1 = 12.5%)**: Исполнение сгенерированного Python-кода подтверждает реальную работоспособность алгоритмов на официальных юнит-тестах OpenAI.
