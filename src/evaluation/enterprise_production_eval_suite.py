...
ENTERPRISE_SCENARIOS = [
    ...
    },
    {
        ...
        "required_concepts": [
            ...
            "iptables / kube-proxy sync delay",
            "readinessprobe",
            "sigterm / sigkill",
    ...
    },
    {
        ...
        "required_concepts": [
            "152-фз / 242-фз",
            "первичная запись в рф цод",
            "псевдонимизация / токенизация",
            "трансграничная передача",
            "роскомнадзор комплаенс",
            "data sovereignty",
        ],
        "code_language": None,
    },
    ...
    # --- DOMAIN 6: FULLSTACK, REACT 19 & HIGH-FREQUENCY FRONTEND (7 scenarios) ---
    {
        ...
        "required_concepts": [
            ...
            "zod validation",
            "revalidatepath",
            "useserveractionstate / useactionstate",
            "typescript types",
        ],
    ...
    },
    {
        ...
        "required_concepts": [
            "module federation",
            "remotes / exposes",
            "shared singleton (react, react-dom)",
            "dynamic remotes",
            "error boundary",
        ],
    ...
    # --- DOMAIN 7: INCIDENT POST-MORTEMS, DEBUGGING & MEMORY PROFILING (7 scenarios) ---
    {
        ...
        "required_concepts": [
            ...
            "flamegraph",
            "goroutine leak (time.Ticker / unbuffered channel)",
            "oomkilled",
            "runtime.GC",
        ],
        "code_language": "go",
    ...
    },
    {
        ...
        "required_concepts": [
            ...
            "fsync latency",
            "kernel block layer tracepoints",
        ],
        "code_language": "bash",
    },
    {
    ...
    },
    {
        ...
        "required_concepts": [
            ...
            "idle timeout on l4 load balancer",
            "goaway frame",
...
def evaluate_enterprise_production_matrix(
    ...
    logger.info(
        f"=== Starting Enterprise Production-Grade Benchmark across {min(len(ENTERPRISE_SCENARIOS), max_scenarios)} Scenarios ==="
    )
    ...
    for idx, sc in enumerate(scenarios, 1):
        ...
        if lora_model:
            ...
            l_text, l_lat, l_tps = (
                base_results[idx - 1]["text"],
                base_results[idx - 1]["latency"],
                base_results[idx - 1]["tps"],
            )
        ...
        if lora_model and rag_hits:
            ...
            h_text, h_lat, h_tps = (
                rag_results[idx - 1]["text"],
                rag_results[idx - 1]["latency"],
                rag_results[idx - 1]["tps"],
            )
        ...
        record = {
            ...
            "hybrid": {
                ...
                "concept_score": round(h_concept_score, 1)
                if lora_model and rag_hits
                else base_results[idx - 1]["concept_score"],
