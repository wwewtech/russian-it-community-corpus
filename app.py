...
# Sidebar Header
st.sidebar.title("🚀 IT Community Data Studio")
st.sidebar.caption("Russian IT Conversational Corpus (2018–2026)")
st.sidebar.markdown("---")
...
nav = st.sidebar.radio(
    ...
    [
        "📊 Главная и метрики",
        "🔍 Исследователь датасета (Explorer)",
        "💬 SFT & DPO диалоговая студия",
        "🧠 База знаний RAG и поиск",
        "🛡️ Zero-PII Песочница деидентификации",
        "📡 Технологический радар и тренды",
        "🎯 Доменный бенчмарк (100 вопросов)",
        "📄 Белые книги и Dataset Card",
    ],
)
...
st.sidebar.info(
    ...
    "- 📩 **525,864** очищенных сообщений\n"
    "- 👤 **27,698** авторов\n"
    "- 🧠 **40,042** SFT диалогов\n"
    "- 📚 **71,436** RAG чанков\n"
    "- ⚡ **18,494** DPO пар\n"
    "- 🔒 **Zero-PII** верифицирован"
)
...
if nav == "📊 Главная и метрики":
    st.title("🔬 Russian IT Community Data Platform (2018–2026)")
    st.markdown(
