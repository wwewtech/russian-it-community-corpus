...
## Base Model: `Vikhrmodels/Vikhr-Qwen-2.5-1.5B-Instruct` (Vikhr Russian NLP · 1.5B)
...
base_model_name = "Vikhrmodels/Vikhr-Qwen-2.5-1.5B-Instruct"
adapter_path = "lora_adapters/vikhr_qwen_2.5_1.5b"
